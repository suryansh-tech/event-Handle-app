-- 010_update_leaderboard_jwt.sql

-- Update get_leaderboard to use JWT claims directly instead of joining profiles
-- Keep the rest of the function identical to 007_restore_full_leaderboard.sql
...
BEGIN
  ...
  ) AND COALESCE(auth.jwt() -> 'app_metadata' ->> 'role', '') != 'super_admin' AND NOT EXISTS (
